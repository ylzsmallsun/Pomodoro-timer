    ...
    <div class="row">
      <div v-show="!isWorking" class="col-sm-12 col-md-6 col-lg-4">
        <div class="jumbotron text-center">
          <div class="container">
            <img class="img-fluid rounded" src="../../../assets/yoga.jpg" alt="">
            <h2></h2>
            <p class="lead">
              Description: Do yoga with positive sentences
            </p>
          </div>
        </div>
      </div>
      <count-down-timer class="col-sm-12 col-md-6 col-lg-8" :time="time"
      @finished="togglePomodoro"></count-down-timer>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    togglePomodoro () {
      ...
      this.pomodoros++
      this.updateTotalPomodoros(this.statistics.totalPomodoros + 1)
